...
export function About() {
    return (
        <div className="bg-cover bg-no-repeat bg-center px-7 sm:px-12 lg:px-20 2xl:px-48 mt-14 sm:mt-16 2xl:mt-32 pb-16 2xl:pb-32" style={{ backgroundImage: `url(${bgImage})` }}>
            <h1 className="text-[28px] sm:text-4xl 2xl:text-5xl text-center font-black mb-4 text-[#8f5cd7] sm:pt-10">Sobre</h1>
